...
export const description = "Намаз статистикасы - Радар диаграммасы"

interface PrayerRadarChartProps {
  data: {
    prayer: string
    prayed: number
    missed: number
...
export function PrayerRadarChart({ data, activeStatus = "all", gender }: PrayerRadarChartProps) {
